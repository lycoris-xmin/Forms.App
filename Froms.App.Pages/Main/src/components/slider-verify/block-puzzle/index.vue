<script lang="ts" setup>
  ...
  import { sliderBlockPuzzleApi } from '@/service/api';
  import Slider from './block-puzzle-slider.vue';
  ...
  async function getSlider() {
    block.loading = true;
    try {
      const { data: res, error } = await sliderBlockPuzzleApi({
        width: props.w,
        height: props.h,
        l: props.l,
        r: props.r,
...
<template>
  <AModal v-model:open="visible" :width="370" :footer="false" :mask-closable="false" :closable="false" :destroy-on-close="true">
    <div class="body">
      <div class="p-5px">
        <Slider
          :l="props.l"
