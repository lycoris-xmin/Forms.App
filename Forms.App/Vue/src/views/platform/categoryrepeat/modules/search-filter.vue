...
defineOptions({
  name: 'CategoryRepeatPurchaseListSearch'
});
...
const model = defineModel<Api.CategoryRepeatPurchase.SearchFilter>('model', { required: true });
    ...
    >
      <ARow :gutter="[16, 16]" wrap>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem label="类目" name="name" class="m-0">
