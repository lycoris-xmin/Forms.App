...
import { apiUrl, fetchCreateDouyinProduct, fetchUpdateDouyinProduct } from '@/service/api';
...
async function createOrUpdate() {
  ...
  try {
    ...
    const { data: res, error } =
      props.operateType === 'edit' ? await fetchUpdateDouyinProduct(json) : await fetchCreateDouyinProduct(json);
