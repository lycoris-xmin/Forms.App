...
import { fetchGetTaobaoProductListForPlanTask, fetchGetTaobaoShopName } from '@/service/api';
...
function getProductList(searchFilter: Api.PlanTask.ProductSearchFilter) {
