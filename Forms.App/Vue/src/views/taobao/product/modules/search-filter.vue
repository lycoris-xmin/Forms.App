...
const model = defineModel<Api.Product.TaobaoSearchFilter>('model', { required: true });
        ...
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem label="所属店铺" name="shopId" class="m-0">
            <ShopNameSelect
              ...
              :allow-clear="!props.userInfo.isTenant"
              :show-search="!props.userInfo.isTenant"
              :options="props.userInfo.isTenant ? props.shopNameEnum : []"
            ></ShopNameSelect>
          </AFormItem>
        </ACol>
