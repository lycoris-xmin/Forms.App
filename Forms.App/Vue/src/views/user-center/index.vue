...
import SubScription from './modules/sub-scription .vue';
    ...
    >
      <div class="card-body">
        <div>
          ...
          <div v-if="authStore.userInfo.isTenant" class="menu-group">
            <p class="title">使用数</p>

            <ul>
              <li :class="{ active: menu.active === 'subscription' }" @click="menuClickHandler('subscription')">
                使用数列表
              </li>
            </ul>
          </div>
          ...
          <div v-if="authStore.userInfo.isTenant" class="menu-group">
            <p class="title">结算设置</p>

            <ul>
              <li :class="{ active: menu.active === 'settlement' }" @click="menuClickHandler('settlement')">
                差价结算
              </li>
            </ul>
          </div>
        ...
        <div class="card-container">
          <Transition name="tab-view" mode="out-in">
            ...
            <Settlement v-else-if="menu.active === 'settlement'"></Settlement>
            <SubScription v-else-if="menu.active === 'subscription'"></SubScription>
          </Transition>
        </div>
      </div>
    </ACard>
